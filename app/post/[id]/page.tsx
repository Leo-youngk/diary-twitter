        ...
        <div className="flex items-center justify-between py-4 border-b border-x-border">
          ...
          {!confirmDelete ? (
            <div className="flex items-center gap-2">
              ...
              {/* Copy */}
              <button onClick={handleCopy} className="group text-x-gray hover:text-x-blue transition-colors p-2 rounded-full" title="复制文本">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="px-4 py-1.5 text-sm font-bold border border-x-border rounded-full hover:bg-x-hover transition-colors"
              >
                取消
              </button>
            </div>
