        ...
        <div className="flex gap-3 px-4 pb-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <textarea
              ...
              className="w-full bg-transparent text-xl text-white placeholder-x-gray outline-none resize-none min-h-[120px] leading-7"
              autoFocus
            />
        ...
        <div className="border-t border-x-border px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-1">
              <button onClick={() => fileInputRef.current?.click()} className="p-2 rounded-full hover:bg-x-blue/10 text-x-blue transition-colors">
